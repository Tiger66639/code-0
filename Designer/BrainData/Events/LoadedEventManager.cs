// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LoadedEventManager.cs" company="">
//   
// </copyright>
// <summary>
//   The event manager for the weak event pattern used for the
//   <see cref="JaStDev.HAB.Brain.Loaded" /> event.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JaStDev.HAB.Designer
{
    ...
    /// </remarks>
    public class LoadedEventManager : System.Windows.WeakEventManager
    {
        /// <summary>
        ...
        private static LoadedEventManager CurrentManager
        {
            get
            {
                var iType = typeof(LoadedEventManager);
                var currentManager = (LoadedEventManager)GetCurrentManager(iType);
                if (currentManager == null)
                {
                    currentManager = new LoadedEventManager();
