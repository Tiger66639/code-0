// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ThesaurusRelItemCollectionEventMonitor.cs" company="">
//   
// </copyright>
// <summary>
//   The thesaurus rel item collection event monitor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JaStDev.HAB.Designer
{
    ...
    /// <summary>The thesaurus rel item collection event monitor.</summary>
    internal class ThesaurusRelItemCollectionEventMonitor : EventMonitor
    {
        /// <summary>Initializes a new instance of the <see cref="ThesaurusRelItemCollectionEventMonitor"/> class.</summary>
        /// <param name="toWrap">The to wrap.</param>
        public ThesaurusRelItemCollectionEventMonitor(ThesaurusRelItemCollection toWrap)
            : base(toWrap)
        {
        }
        ...
        ///     The item.
        /// </value>
        public ThesaurusRelItemCollection Item
        {
            get
            {
                if (Reference.IsAlive)
                {
                    return (ThesaurusRelItemCollection)Reference.Target;
                }
