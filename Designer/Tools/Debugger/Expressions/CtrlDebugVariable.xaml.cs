// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CtrlDebugVariable.xaml.cs" company="">
//   
// </copyright>
// <summary>
//   Interaction logic for CtrlDebugVariable.xaml
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JaStDev.HAB.Designer
{
    ...
    ///     Interaction logic for CtrlDebugVariable.xaml
    /// </summary>
    public partial class CtrlDebugVariable : CtrlEditorItem
    {
        /// <summary>Initializes a new instance of the <see cref="CtrlDebugVariable"/> class.</summary>
        public CtrlDebugVariable()
        {
            InitializeComponent();
        }
