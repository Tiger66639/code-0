// --------------------------------------------------------------------------------------------------------------------
// <copyright file="POSGroupCreatedEventManager.cs" company="">
//   
// </copyright>
// <summary>
//   The pos group created event manager.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JaStDev.HAB.Designer
{
    /// <summary>The pos group created event manager.</summary>
    public class POSGroupCreatedEventManager : System.Windows.WeakEventManager
    {
        /// <summary>
        ...
        ///     The current manager.
        /// </value>
        private static POSGroupCreatedEventManager CurrentManager
        {
            get
            {
                var iType = typeof(POSGroupCreatedEventManager);
                var currentManager = (POSGroupCreatedEventManager)GetCurrentManager(iType);
                if (currentManager == null)
                {
                    currentManager = new POSGroupCreatedEventManager();
        ...
        protected override void StartListening(object source)
        {
            ...
            iSource.POSGroupCreated += PosGroupCreated;
        }
        ...
        private void PosGroupCreated(object sender, PosGroupEventArgs e)
        {
