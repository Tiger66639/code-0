// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RelationshipCreatedEventManager.cs" company="">
//   
// </copyright>
// <summary>
...
namespace JaStDev.HAB.Designer
{
    ...
    /// </remarks>
    public class RelationshipCreatedEventManager : System.Windows.WeakEventManager
    {
        /// <summary>
        ...
        ///     The current manager.
        /// </value>
        private static RelationshipCreatedEventManager CurrentManager
        {
            get
            {
                var iType = typeof(RelationshipCreatedEventManager);
                var currentManager = (RelationshipCreatedEventManager)GetCurrentManager(iType);
                if (currentManager == null)
                {
                    currentManager = new RelationshipCreatedEventManager();
        ...
        protected override void StartListening(object source)
        {
            ...
            iSource.RelationshipCreated += RelationshipCreated;
        }
        ...
        private void RelationshipCreated(object sender, NewRelationshipEventArgs e)
        {
