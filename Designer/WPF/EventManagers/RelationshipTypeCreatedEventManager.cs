// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RelationshipTypeCreatedEventManager.cs" company="">
//   
// </copyright>
// <summary>
//   The event manager for the weak event pattern used for the
//   <see cref="JaStDev.HAB.WordNetSin.RelationshipTypeCreated" /> event.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JaStDev.HAB.Designer
{
    ...
    /// </remarks>
    public class RelationshipTypeCreatedEventManager : System.Windows.WeakEventManager
    {
        /// <summary>
        ...
        private static RelationshipTypeCreatedEventManager CurrentManager
        {
            get
            {
                var iType = typeof(RelationshipTypeCreatedEventManager);
                var currentManager = (RelationshipTypeCreatedEventManager)GetCurrentManager(iType);
        ...
        protected override void StartListening(object source)
        {
            ...
            iSource.RelationshipTypeCreated += RelationshipTypeCreated;
        }
        ...
        private void RelationshipTypeCreated(object sender, NewMetaTypeEventArgs e)
        {
