// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FrameUndoItem.cs" company="">
//   
// </copyright>
// <summary>
//   Base class for the undo data for a frame add/delete to the list of the
//   editor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JaStDev.HAB.Designer
{
    ...
    ///     editor.
    /// </summary>
    public class FrameUndoItem : UndoSystem.UndoItem
    {
        /// <summary>
