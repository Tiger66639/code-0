// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FrameElementListItemDragAdvisor.cs" company="">
//   
// </copyright>
// <summary>
//   The frame element list item drag advisor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JaStDev.HAB.Designer
{
    /// <summary>The frame element list item drag advisor.</summary>
    public class FrameElementListItemDragAdvisor : DnD.DragSourceBase
    {
        /// <summary>Initializes a new instance of the <see cref="FrameElementListItemDragAdvisor"/> class.</summary>
        public FrameElementListItemDragAdvisor()
        {
        ...
        public FrameElement Item
        {
            get
            {
                return ((System.Windows.FrameworkElement)SourceUI).DataContext as FrameElement;
            }
        }
