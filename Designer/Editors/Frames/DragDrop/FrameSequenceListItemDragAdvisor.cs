// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FrameSequenceListItemDragAdvisor.cs" company="">
//   
// </copyright>
// <summary>
//   The frame sequence list item drag advisor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JaStDev.HAB.Designer
{
    /// <summary>The frame sequence list item drag advisor.</summary>
    public class FrameSequenceListItemDragAdvisor : DnD.DragSourceBase
    {
        /// <summary>Initializes a new instance of the <see cref="FrameSequenceListItemDragAdvisor"/> class.</summary>
        public FrameSequenceListItemDragAdvisor()
        {
        ...
        /// <summary>
        ///     Gets the item that is the datacontext of the target of this drop
        ///     advisor.
        /// </summary>
        public FrameSequence Item
        {
            get
            {
                return ((System.Windows.FrameworkElement)SourceUI).DataContext as FrameSequence;
            }
        }
        ...
        public FrameOrderCollection Items
        {
            get
            {
                ...
                var iItemsControl = System.Windows.Controls.ItemsControl.ItemsControlFromItemContainer(iListBoxItem);
        ...
        public override System.Windows.DataObject GetDataObject(System.Windows.UIElement draggedElt)
        {
            ...
            iObj.SetData(Properties.Resources.FrameSequenceFormat, iContent);
