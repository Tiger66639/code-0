// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FrameListDropAdvisor.cs" company="">
//   
// </copyright>
// <summary>
//   Provides drop functionality for itemsControls that contain frames.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JaStDev.HAB.Designer
{
    ...
    ///     Provides drop functionality for itemsControls that contain frames.
    /// </summary>
    public class FrameListDropAdvisor : DnD.DropTargetBase
    {
        ...
        private void TryCreateNewItem(System.Windows.DragEventArgs obj, System.Windows.Point dropPoint)
        {
            ...
            var iFound = Brain.Current[iId] as NeuronCluster;
            if (iFound != null)
            {
                var iNew = new Frame(iFound);
                var iList = Items;
        ...
        public System.Collections.Generic.IList<Frame> Items
        {
            get
            {
                return Target.ItemsSource as System.Collections.Generic.IList<Frame>;
            }
        }
