// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ResponsesForGroupsEnumerator.cs" company="">
//   
// </copyright>
// <summary>
//   enumerates through the list of ResponsesForGroups in a rule.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JaStDev.HAB.Designer
{
    ...
    ///     enumerates through the list of ResponsesForGroups in a rule.
    /// </summary>
    public class ResponsesForGroupsEnumerator : System.Collections.IEnumerator, System.Collections.IEnumerable
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="ResponsesForGroupsEnumerator"/> class.</summary>
        /// <param name="value">The value.</param>
        public ResponsesForGroupsEnumerator(NeuronCluster value)
        {
            fItem = value;
        }
        ...
        public virtual object Current
        {
            get
            {
                var iRes = new ResponsesForGroupEnumerator((NeuronCluster)fItems[Counter]);
                return iRes;
            }
        }
