// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FlowConditionalDropAdvisor.cs" company="">
//   
// </copyright>
// <summary>
//   The flow conditional drop advisor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JaStDev.HAB.Designer
{
    /// <summary>The flow conditional drop advisor.</summary>
    public class FlowConditionalDropAdvisor : DnD.DropTargetBase
    {
        ...
        public FlowItemCollection CodeList
        {
            get
            {
                var iCond = Target.DataContext as FlowItemConditional;
                if (iCond != null)
                {
                    return iCond.Items;
                }
