// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FlowListItemDragAdvisor.cs" company="">
//   
// </copyright>
// <summary>
//   The flow list item drag advisor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JaStDev.HAB.Designer
{
    /// <summary>The flow list item drag advisor.</summary>
    public class FlowListItemDragAdvisor : DnD.DragSourceBase
    {
        /// <summary>Initializes a new instance of the <see cref="FlowListItemDragAdvisor"/> class.</summary>
        public FlowListItemDragAdvisor()
        {
        ...
        public FlowItem Item
        {
            get
            {
                return ((System.Windows.FrameworkElement)SourceUI).DataContext as FlowItem;
            }
        }
        ...
        {
            return Item != null && FlowList != null;
        }
        ...
        public override System.Windows.DataObject GetDataObject(System.Windows.UIElement draggedElt)
        {
            ...
            iObj.SetData(Properties.Resources.FLOWITEMFORMAT, iContent);
