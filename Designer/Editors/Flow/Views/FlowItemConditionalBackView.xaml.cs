// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FlowItemConditionalBackView.xaml.cs" company="">
//   
// </copyright>
// <summary>
//   Interaction logic for FlowItemConditionalBackView.xaml
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JaStDev.HAB.Designer.WPF.Controls
{
    ...
    ///     Interaction logic for FlowItemConditionalBackView.xaml
    /// </summary>
    public partial class FlowItemConditionalBackView : System.Windows.Controls.UserControl
    {
        /// <summary>Initializes a new instance of the <see cref="FlowItemConditionalBackView"/> class.</summary>
        public FlowItemConditionalBackView()
        {
            InitializeComponent();
        }
