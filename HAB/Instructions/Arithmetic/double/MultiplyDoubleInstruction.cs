// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MultiplyDoubleInstruction.cs" company="">
//   
// </copyright>
// <summary>
...
namespace JaStDev.HAB
{
    ...
    ///     </list>
    /// </remarks>
    [NeuronID((ulong)PredefinedNeurons.MultiplyDoubleInstruction)]
    public class MultiplyDoubleInstruction : SingleResultInstruction, ICalculateDouble, IExecResultStatement
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.MultiplyDoubleInstruction;
            }
        }
        ...
        {
            double iVal;
            if (CalculateDouble(processor, list[1], out iVal))
            {
                return ((DoubleNeuron)list[0]).Value * iVal;
            }

            LogService.Log.LogError("double * double", "second argument should be a double.");
            return 0;
        }
        ...
        protected override Neuron InternalGetValue(Processor processor, System.Collections.Generic.IList<Neuron> list)
        {
            ...
            LogService.Log.LogError("MultiplyDouble.GetValues", "Invalid nr of arguments specified");
            return null;
        }
