// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DivDoubleInstruction.cs" company="">
//   
// </copyright>
// <summary>
...
namespace JaStDev.HAB
{
    ...
    ///     </list>
    /// </remarks>
    [NeuronID((ulong)PredefinedNeurons.DivDoubleInstruction)]
    public class DivDoubleInstruction : SingleResultInstruction, ICalculateDouble, IExecResultStatement
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.DivDoubleInstruction;
            }
        }
        ...
        protected override Neuron InternalGetValue(Processor processor, System.Collections.Generic.IList<Neuron> list)
        {
            ...
            LogService.Log.LogError("DivDouble.GetValues", "Invalid nr of arguments specified");
            return null;
        }
