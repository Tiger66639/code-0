// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MinusDoubleInstruction.cs" company="">
//   
// </copyright>
// <summary>
...
namespace JaStDev.HAB
{
    ...
    ///     </list>
    /// </remarks>
    [NeuronID((ulong)PredefinedNeurons.MinusDoubleInstruction)]
    public class MinusDoubleInstruction : SingleResultInstruction, ICalculateDouble, IExecResultStatement
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.MinusDoubleInstruction;
            }
        }
        ...
        protected override Neuron InternalGetValue(Processor processor, System.Collections.Generic.IList<Neuron> list)
        {
            ...
            LogService.Log.LogError("MinusDouble.GetValues", "Invalid nr of arguments specified");
            return null;
        }
