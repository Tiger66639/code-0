// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DivStoreDoubleInstruction.cs" company="">
//   
// </copyright>
// <summary>
...
namespace JaStDev.HAB
{
    ...
    ///     store the result in a double.
    /// </summary>
    [NeuronID((ulong)PredefinedNeurons.DivStoreDoubleInstruction)]
    public class DivStoreDoubleInstruction : Instruction, IExecStatement
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.DivStoreDoubleInstruction;
            }
        }
        ...
        public bool Perform(Processor handler, System.Collections.Generic.IList<Neuron> list)
        {
            if (list.Count == 3)
            {
                ...
                if (iRes == null)
                {
                    LogService.Log.LogWarning("DivStoreDouble", "first arg should be a double");
                    return true;
                }
                ...
                try
                {
                    if (CalculateDouble(handler, list[1], out iSecond) == false)
                    {
                        ...
                        {
                            LogService.Log.LogWarning("DivStoreDouble", "second arg should be an int or double");
                            return true;
                        }
                    }
                    ...
                    if (CalculateDouble(handler, list[2], out iThird) == false)
                    {
                        ...
                        {
                            LogService.Log.LogWarning("DivStoreDouble", "third arg should be an int or double");
                            return true;
                        }
                    }
