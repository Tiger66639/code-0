// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MultiplyStoreDoubleIntruction.cs" company="">
//   
// </copyright>
// <summary>
...
namespace JaStDev.HAB
{
    ...
    ///     store the result in a double.
    /// </summary>
    [NeuronID((ulong)PredefinedNeurons.MultiplyStoreDoubleIntruction)]
    public class MultiplyStoreDoubleIntruction : Instruction, IExecStatement
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.MultiplyStoreDoubleIntruction;
            }
        }
        ...
        public bool Perform(Processor handler, System.Collections.Generic.IList<Neuron> list)
        {
            if (list.Count == 3)
            {
                ...
                if (iRes == null)
                {
                    LogService.Log.LogWarning("MultiplyStoreDouble", "first arg should be a double");
                    return true;
                }
                ...
                try
                {
                    if (CalculateDouble(handler, list[1], out iSecond) == false)
                    {
                        ...
                        {
                            LogService.Log.LogWarning("MultiplyStoreDouble", "second arg should be an int or double");
                            return true;
                        }
                    }
                    ...
                    if (CalculateDouble(handler, list[2], out iThird) == false)
                    {
                        ...
                        {
                            LogService.Log.LogWarning("DivStoreDouble", "third arg should be an in or doublet");
                            return true;
                        }
                    }
