// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AvgInstruction.cs" company="">
//   
// </copyright>
// <summary>
//   Returns the average vaalue of all the arguments, which must either be an
...
namespace JaStDev.HAB
{
    ...
    ///     </list>
    /// </remarks>
    [NeuronID((ulong)PredefinedNeurons.AvgInstruction)]
    public class AvgInstruction : SingleResultInstruction
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.AvgInstruction;
            }
        }
        ...
        protected override Neuron InternalGetValue(Processor processor, System.Collections.Generic.IList<Neuron> list)
        {
            if (list != null && list.Count >= 1)
            {
                ...
                LogService.Log.LogError(
                    "AvgInstruction.GetValues", 
                    "All arguments must be a time cluster or a value type (either IntNeuron or DoubleNeuron)!");
            }
            else
            {
                LogService.Log.LogError("AvgInstruction.GetValues", "Invalid nr of arguments specified");
            }
        ...
        private Neuron TryTimeWithTime(System.Collections.Generic.IList<Neuron> list, Processor proc)
        {
            ...
            var iVal = Enumerable.Average(iVals);
            return Time.Current.GetTimeCluster(new System.DateTime((long)iVal), proc);
        }
