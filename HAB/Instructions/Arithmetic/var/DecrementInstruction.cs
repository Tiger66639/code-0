// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DecrementInstruction.cs" company="">
//   
// </copyright>
// <summary>
//   Decrements the value of every neuron (only <see langword="int" /> or
...
namespace JaStDev.HAB.Instructions.Arithmetic
{
    ...
    ///     </list>
    /// </remarks>
    [NeuronID((ulong)PredefinedNeurons.DecrementInstruction)]
    public class DecrementInstruction : MultiResultInstruction
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.DecrementInstruction;
            }
        }
        ...
        public override void GetValues(Processor processor, System.Collections.Generic.IList<Neuron> list)
        {
            ...
            {
                LogService.Log.LogError("Decrement.GetValues", "No arguments specified");
            }
        }
