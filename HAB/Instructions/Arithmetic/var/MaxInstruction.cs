// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MaxInstruction.cs" company="">
//   
// </copyright>
// <summary>
//   Returns the maximum vlaue of all the arguments, which must either be an
...
namespace JaStDev.HAB
{
    ...
    ///     </list>
    /// </remarks>
    [NeuronID((ulong)PredefinedNeurons.MaxInstruction)]
    public class MaxInstruction : SingleResultInstruction
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.MaxInstruction;
            }
        }
        ...
        protected override Neuron InternalGetValue(Processor processor, System.Collections.Generic.IList<Neuron> list)
        {
            if (list != null && list.Count >= 1)
            {
                ...
                LogService.Log.LogError(
                    "MaxInstruction.GetValues", 
                    "All arguments must be a time cluster or a value type (either IntNeuron or DoubleNeuron)!");
            }
            else
            {
                LogService.Log.LogError("MaxInstruction.GetValues", "Invalid nr of arguments specified");
            }
