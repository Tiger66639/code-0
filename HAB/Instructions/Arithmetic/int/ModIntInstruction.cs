// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModIntInstruction.cs" company="">
//   
// </copyright>
// <summary>
...
namespace JaStDev.HAB
{
    ...
    ///     </list>
    /// </remarks>
    [NeuronID((ulong)PredefinedNeurons.ModIntInstruction)]
    public class ModIntInstruction : SingleResultInstruction, ICalculateInt, IExecResultStatement
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.ModIntInstruction;
            }
        }
        ...
        protected override Neuron InternalGetValue(Processor processor, System.Collections.Generic.IList<Neuron> list)
        {
            ...
            LogService.Log.LogError("ModInt.GetValues", "Invalid nr of arguments specified");
            return null;
        }
        ...
        public int GetInt(Processor handler, System.Collections.Generic.IList<Neuron> args)
        {
            ...
            {
                LogService.Log.LogError("ModInt", "invalid first arg: double expeced, found: " + args[0].TypeOfNeuron);
            }
