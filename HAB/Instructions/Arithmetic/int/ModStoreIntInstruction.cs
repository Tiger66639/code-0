// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModStoreIntInstruction.cs" company="">
//   
// </copyright>
// <summary>
...
namespace JaStDev.HAB
{
    ...
    ///     store the result in an int.
    /// </summary>
    [NeuronID((ulong)PredefinedNeurons.ModStoreIntInstruction)]
    public class ModStoreIntInstruction : Instruction, IExecStatement
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.ModStoreIntInstruction;
            }
        }
        ...
        public bool Perform(Processor handler, System.Collections.Generic.IList<Neuron> list)
        {
            if (list.Count == 3)
            {
                ...
                if (iRes == null)
                {
                    LogService.Log.LogWarning("ModStoreInt", "first arg should be an int");
                    return true;
                }
                ...
                try
                {
                    if (CalculateInt(handler, list[1], out iSecond) == false)
                    {
                        ...
                        {
                            LogService.Log.LogWarning("ModStoreInt", "second arg should be an int");
                            return true;
                        }
                    }
                    ...
                    if (CalculateInt(handler, list[2], out iThird) == false)
                    {
                        ...
                        {
                            LogService.Log.LogWarning("ModStoreInt", "third arg should be an int");
                            return true;
                        }
                    }
        ...
        public override void Execute(Processor processor, System.Collections.Generic.IList<Neuron> args)
        {
            ...
            {
                LogService.Log.LogError("ModStoreInt", "Invalid nr of arguments.");
            }
        }
    }
}