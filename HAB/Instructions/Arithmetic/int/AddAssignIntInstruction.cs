// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AddAssignIntInstruction.cs" company="">
//   
// </copyright>
// <summary>
...
namespace JaStDev.HAB
{
    ...
    ///     the value to add to the first arg
    /// </summary>
    [NeuronID((ulong)PredefinedNeurons.AddAssignIntInstruction)]
    public class AddAssignIntInstruction : Instruction, IExecStatement
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.AddAssignIntInstruction;
            }
        }
        ...
        public override void Execute(Processor processor, System.Collections.Generic.IList<Neuron> args)
        {
            ...
            try
            {
                var iArg1 = (IntNeuron)args[0];
                iArg1.SetValueDirect(iArg1.Value + ((IntNeuron)args[1]).Value);
            }
            finally
            {
