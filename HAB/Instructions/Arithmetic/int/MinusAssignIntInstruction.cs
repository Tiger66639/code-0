// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MinusAssignIntInstruction.cs" company="">
//   
// </copyright>
// <summary>
//   a faster instruction to perform -= on an <see langword="int" /> value with
//   another int. arg 1: the <see langword="int" /> to store the value to 2:
//   the value to add to the first arg
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JaStDev.HAB
{
    ...
    ///     the value to add to the first arg
    /// </summary>
    [NeuronID((ulong)PredefinedNeurons.MinusAssignIntInstruction)]
    public class MinusAssignIntInstruction : Instruction, IExecStatement
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.MinusAssignIntInstruction;
            }
        }
        ...
        public override void Execute(Processor processor, System.Collections.Generic.IList<Neuron> args)
        {
            ...
            try
            {
                var iArg = (IntNeuron)args[0];
                iArg.SetValueDirect(iArg.Value - ((IntNeuron)args[1]).Value);
            }
            finally
            {
