// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MultiplyIntInstruction.cs" company="">
//   
// </copyright>
// <summary>
...
namespace JaStDev.HAB
{
    ...
    ///     </list>
    /// </remarks>
    [NeuronID((ulong)PredefinedNeurons.MultiplyIntInstruction)]
    public class MultiplyIntInstruction : SingleResultInstruction, ICalculateInt, IExecResultStatement
    {
        #region TypeOfNeuron
        ...
        /// </summary>
        /// <value>
        ///     <see cref="PredefinedNeurons.MultiplyIntInstruction " /> .
        /// </value>
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.MultiplyIntInstruction;
            }
        }
        ...
        protected override Neuron InternalGetValue(Processor processor, System.Collections.Generic.IList<Neuron> list)
        {
            ...
            LogService.Log.LogError("MultiplyInt.GetValues", "Invalid nr of arguments specified");
            return null;
        }
