// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AddIntInstruction.cs" company="">
//   
// </copyright>
// <summary>
...
namespace JaStDev.HAB.Instructions.Arithmetic
{
    ...
    ///     </list>
    /// </remarks>
    [NeuronID((ulong)PredefinedNeurons.AddIntInstruction)]
    public class AddIntInstruction : SingleResultInstruction, ICalculateInt, IExecResultStatement
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.AddIntInstruction;
            }
        }
        ...
        protected override Neuron InternalGetValue(Processor processor, System.Collections.Generic.IList<Neuron> list)
        {
            ...
            LogService.Log.LogError("AddInt.GetValues", "Invalid nr of arguments specified");
            return null;
        }
        ...
        public int GetInt(Processor handler, System.Collections.Generic.IList<Neuron> args)
        {
            ...
            {
                LogService.Log.LogError("AddInt", "invalid first arg: double expeced, found: " + args[0].TypeOfNeuron);
            }
