// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InvertDoubleListInstruction.cs" company="">
//   
// </copyright>
// <summary>
...
namespace JaStDev.HAB
{
    ...
    ///     Gets the boolean inverse of the argument.
    /// </summary>
    [NeuronID((ulong)PredefinedNeurons.InvertDoubleListInstruction)]
    public class InvertDoubleListInstruction : MultiResultInstruction
    {
        #region TypeOfNeuron
        ...
        public override void GetValues(Processor processor, System.Collections.Generic.IList<Neuron> list)
        {
            if (list != null && list.Count >= 1)
            {
                ...
                {
                    var iInt = NeuronFactory.GetDouble(-((DoubleNeuron)list[0]).Value);
            ...
            {
                LogService.Log.LogError("InvertDoubleList", "No arguments specified");
            }
        }
    }
}