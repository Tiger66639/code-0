// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IToSInstruction.cs" company="">
//   
// </copyright>
// <summary>
//   Converts an <see langword="int" /> into a string neuron. It is possible to
...
namespace JaStDev.HAB
{
    ...
    ///     </list>
    /// </remarks>
    [NeuronID((ulong)PredefinedNeurons.IToSInstruction)]
    public class IToSInstruction : MultiResultInstruction
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.IToSInstruction;
            }
        }
        ...
        public override void GetValues(Processor processor, System.Collections.Generic.IList<Neuron> list)
        {
            if (list != null && list.Count >= 1)
            {
                ...
                foreach (var iNeuron in list)
                {
                    ...
                    {
                        LogService.Log.LogError("IToSInstruction.GetValues", "Arguments must be int neurons!");
                        return;
                    }
                }
            ...
            {
                LogService.Log.LogError("IToSInstruction.GetValues", "Invalid nr of arguments specified!");
            }
        }
    }
}