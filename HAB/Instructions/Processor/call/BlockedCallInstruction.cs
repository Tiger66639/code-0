// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BlockedCallInstruction.cs" company="">
//   
// </copyright>
// <summary>
...
namespace JaStDev.HAB
{
    ...
    ///     </list>
    /// </remarks>
    [NeuronID((ulong)PredefinedNeurons.BlockedCallInstruction)]
    public class BlockedCallInstruction : Instruction
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.BlockedCallInstruction;
            }
        }
        ...
        public override void Execute(Processor processor, System.Collections.Generic.IList<Neuron> args)
        {
            if (args != null && args.Count >= 1)
            {
                ...
                if (iCluster != null)
                {
                    ...
                    iNew.CallBlocked(iCluster);
                }
                else
                {
                    LogService.Log.LogError("BlockedCall.Execute", "First argument should be a neuron cluster.");
                }
            }
            else
            {
                LogService.Log.LogError("BlockedCall.Execute", "No arguments specified");
            }
        }
    }
}