// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RemoveLinksInInstruction.cs" company="">
//   
// </copyright>
// <summary>
...
namespace JaStDev.HAB
{
    ...
    /// </remarks>
    [NeuronID((ulong)PredefinedNeurons.RemoveLinksInInstruction)]
    public class RemoveLinksInInstruction : Instruction
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.RemoveLinksInInstruction;
            }
        }
        ...
        public override void Execute(Processor processor, System.Collections.Generic.IList<Neuron> args)
        {
            ...
            if (args.Count >= 2)
            {
                if (args[0] != null)
                {
                    if (args[0].ID == EmptyId)
                    {
                        ...
                        LogService.Log.LogError("RemoveLinksInInstruction.Execute", "From part is null (first arg).");
                        return;
                    }

                    if (args[1] == null || args[1].ID == EmptyId)
                    {
                        LogService.Log.LogError("RemoveLinksInInstruction.Execute", "meaning is null (second arg).");
                        return;
                    }
                    ...
                    if (args[0].LinksInIdentifier != null)
                    {
                        ...
                        using (var iLinks = args[0].LinksIn) iTemp.AddRange(iLinks);
            ...
            {
                LogService.Log.LogError("RemoveLinksInInstruction.Execute", "Invalid nr of arguments specified");
            }
        }
    }
}