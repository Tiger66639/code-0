// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetPrevInfoInstruction.cs" company="">
//   
// </copyright>
// <summary>
//   Gets the prev neuron found on the <see cref="JaStDev.HAB.Link.Info" />
...
namespace JaStDev.HAB
{
    ...
    /// </summary>
    /// <remarks>
    ///     Arg: 1: From part 2: To part 3: meaning part 4: next item
    /// </remarks>
    [NeuronID((ulong)PredefinedNeurons.GetPrevInfoInstruction)]
    public class GetPrevInfoInstruction : SingleResultInstruction
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.GetPrevInfoInstruction;
            }
        }
        ...
        protected override Neuron InternalGetValue(Processor processor, System.Collections.Generic.IList<Neuron> list)
        {
                            ...
                            try
                            {
                                ...
                                if (iFound != null)
                                {
                                    if (iFound.InfoIdentifier != null)
                                    {
                                        ...
                                        if (iNext != null)
                                        {
                                            var iIndex = iFound.InfoDirect.IndexOf(iNext.ID);
                                            if (iIndex > 0)
                                            {
                                        ...
                                        else
                                        {
                                            LogService.Log.LogError(
                                                "GetPrevInfoInstruction.InternalGetValue", 
            ...
            {
                LogService.Log.LogError("GetPrevInfoInstruction.InternalGetValue", "Invalid nr of arguments specified");
            }
