// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetNextClusterInstruction.cs" company="">
//   
// </copyright>
// <summary>
...
namespace JaStDev.HAB
{
    ...
    /// </remarks>
    [NeuronID((ulong)PredefinedNeurons.GetNextClusterInstruction)]
    public class GetNextClusterInstruction : SingleResultInstruction
    {
        #region TypeOfNeuron
        ...
        public override ulong TypeOfNeuronID
        {
            get
            {
                return (ulong)PredefinedNeurons.GetNextClusterInstruction;
            }
        }
        ...
        protected override Neuron InternalGetValue(Processor processor, System.Collections.Generic.IList<Neuron> list)
        {
            if (list != null && list.Count >= 3)
            {
                var iChild = list[0];
                var iMeaning = list[1];
                var iPrev = list[2] as NeuronCluster;
                if (iChild != null)
                {
                    if (iMeaning != null)
                    {
