// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LinkInSelectSource.cs" company="">
//   
// </copyright>
// <summary>
//   walks through the incomming links of a neuron.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace JaStDev.HAB
{
    ...
    ///     walks through the incomming links of a neuron.
    /// </summary>
    public class LinkInSelectSource : IForEachSource, 
                                          ...
                                          <System.Collections.Generic.IEnumerable<Neuron>>
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="LinkInSelectSource"/> class. Initializes a new instance of the <see cref="LinkInSelectSource"/>
        ///     class.</summary>
        /// <param name="source">The source.</param>
        public LinkInSelectSource(Neuron source)
        {
            ...
            {
                using (var iLinks = source.LinksIn) fSource.Source.AddRange(iLinks);
            }
        }

        /// <summary>Initializes a new instance of the <see cref="LinkInSelectSource"/> class. Prevents a default instance of the <see cref="ClustersSelectSource"/>
        ///     class from being created. for duplicate.</summary>
        /// <param name="count">The count.</param>
        /// <param name="source">The source.</param>
        private LinkInSelectSource(int count, RefCountedList<Link> source)
        {
            fCount = count;
            fSource = source;
        ...
        {
            return new LinkInSelectSource(fCount, fSource);
        }
        ...
        public bool MoveNext()
        {
            ...
            {
                fCurrentF = fSource.Source[fCount].From;
